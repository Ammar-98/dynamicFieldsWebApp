...
import { Field, Section } from "./Types/types.ts";
...
export default function AddFieldModal({ openModal, setOpenModal, section_id }) {
  ...
  const tempField: Field = {
    ...
    field_id: Sectiondata[section_id]?.fields?.length + 1,
    type: "InputField",
  ...
  const AddFieldFunction = () => {
    ...
    let temp = [...Data[section_id].fields];

    temp.push(tempField);

    Data[section_id].fields = temp;
