...
export default function AddSubFieldModal({
  openModal,
  setOpenModal,
  section_id,
  field_id,
  ...
  const tempField: SubField = {
    ...
    field_id: field_id,
    subField_id:
      Sectiondata[section_id]?.fields[field_id]?.subFields?.length + 1,
    type: "InputField",
  ...
  const AddFieldFunction = () => {
    ...
    let temp = [...Data[section_id].fields[field_id].subFields];

    temp.push(tempField);

    Data[section_id].fields[field_id].subFields = temp;
